...
class ScentListFragment : BaseViewModelFragment() {
    ...
    private lateinit var scentListAdapter: ScentListAdapter
    ...
    private fun initRecyclerView() {
        ...
        scentListAdapter = ScentListAdapter(glideRequests)
        scentListAdapter.data = mutableListOf(
            ScentListData(
        ...
        binding.recyclerView.adapter = scentListAdapter
        scentListAdapter.notifyDataSetChanged()
    }
