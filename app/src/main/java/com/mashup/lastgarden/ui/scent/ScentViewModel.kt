...
class ScentViewModel : ViewModel() {
    ...
    fun getScentList() {
        val tagList1 = listOf("노을", "해질녘", "선선함", "가을")
        val tagList2 = listOf("뽀송함", "빨래", "섬유유연제")
        val tagList3 = listOf("꽃향", "싱그러운", "꽃밭")

        _scentList.value =
            listOf(ScentItem("https://us.123rf.com/450wm/farang/farang1304/farang130400041/19250164-%EC%9E%A5%EC%97%84%ED%95%9C-%EC%9D%BC%EB%AA%B0-%ED%95%98%EB%8A%98-%EC%84%B8%EB%A1%9C-%ED%8C%8C%EB%85%B8%EB%9D%BC%EB%A7%88.jpg?ver=6",
                ...
                11,
                35),
                ScentItem("https://imgc.1300k.com/aaaaaib/goods/215025/54/215025540976.jpg?3",
                    "https://file.mk.co.kr/meet/neds/2020/04/image_readtop_2020_356074_15861373034151671.jpg",
                    "다유니",
                    tagList2,
                    32,
                    51),
                ScentItem("https://file.mk.co.kr/meet/neds/2021/05/image_readtop_2021_505022_16219901034654699.jpg",
